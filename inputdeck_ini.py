...
for kkk in [0,1,2]:#range(len(casefolder)): #iteration over cases
    
    for lll in range(len(timesteps)): #iteration over BUsteps
...
##### end of post processing block
        ...
        if kkk not in []: #no flux data here #i fixed it.....
